# from models import *
# from models.encoder_decoder.my_ed_ConvLSTM import Encode_Decode_ConvLSTM
# from config import cfg
# from collections import OrderedDict
from models.convlstm import ConvLSTM
from models.trajgru import TrajGRU
from models.mim_0 import MIM
from models.encoder_decoder.my_ed_ConvLSTM import Encode_Decode_ConvLSTM
from config import cfg
from collections import OrderedDict

b = cfg.batch
h = cfg.height // cfg.patch_size
w = cfg.width // cfg.patch_size
...
# elif cfg.model_name == 'MK-LSTM':
    # rnn = MK_LSTM
elif cfg.model_name == 'my_ed_ConvLSTM':
    rnn = Encode_Decode_ConvLSTM
else:
    rnn = None
...
if cfg.dataset in ['human3.6m', 'ucf50', 'sports10']:
    ...
    nets = [OrderedDict(), rnn, OrderedDict()]
else:
    nets = [OrderedDict({'conv_embed': [cfg.patch_size * cfg.patch_size, hs, 1, 1, 0, 1]}),
            rnn,
            OrderedDict({'conv_fc': [hs,cfg.patch_size * cfg.patch_size, 1, 1, 0, 1]})]
